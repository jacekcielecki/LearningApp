...
namespace LearningApp.Application.Services
{
    ...
    public class AchievementService : IAchievementService
    {
        ...
        public AchievementService(LearningAppDbContext dbContext,
            IMapper mapper,
            IValidator<CreateAchievementRequest> createAchievementRequest,
            IValidator<UpdateAchievementRequest> updateAchievementRequest)
        {

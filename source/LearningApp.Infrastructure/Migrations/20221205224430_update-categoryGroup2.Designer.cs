...
namespace WSBLearn.Dal.Migrations
{
    ...
    [Migration("20221205224430_update-categoryGroup2")]
    partial class updatecategoryGroup2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WSBLearn.Domain.Entities.CategoryGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryCategoryGroup", b =>
                {
                    b.HasOne("WSBLearn.Domain.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WSBLearn.Domain.Entities.CategoryGroup", null)
                        .WithMany()

...
namespace WSBLearn.WebApi.Services
{
    public class AzureStorage : IAzureStorage
    {
        ...
        {
            _storageConnectionString = configuration.GetValue<string>("BlobStorage:ConnectionString");
            _storageContainerName = configuration.GetValue<string>("BlobStorage:ContainerName");
            _logger = logger;
        }
